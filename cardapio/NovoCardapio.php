...
<div class="container">
<h2>Cardápio</h2>
  <form method="post" action="InserirItensTeste.php">
  <div class="center">
...
<div class="col">
  ...
  <select id="itensc" class="form-control" name="itensc">
...
<!-- finaliza html para os combosbox pegar os itens do cardápio -->

<!-- html para salvar no banco as informações setadas -->
  <br><br>
